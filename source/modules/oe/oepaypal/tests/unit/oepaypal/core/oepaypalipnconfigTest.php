...
/**
 * Class Unit_oePayPal_core_oePayPalIpnConfigTest
 */
class Unit_oePayPal_core_oePayPalIpnConfigTest extends OxidTestCase
{
    public function providerGetPayPalIpnHost()
    {
        return array(
            ...
            'default_IPN_sandbox_host' =>
                array(true, null, null, oePayPalIpnConfig::OEPAYPAL_IPN_SANDBOX_HOST),
            // Default PayPal IPN host.
            'default_IPN_host' =>
                array(false, null, null, oePayPalIpnConfig::OEPAYPAL_IPN_HOST),
    ...
    {
        $IpnConfig = new oePayPalIpnConfig();
    ...
    public function providerGetPayPalIpnCallbackUrl()
    {
        return array(
            ...
            'default_IPN_sandbox_url' =>
                array(true, null, null, oePayPalIpnConfig::OEPAYPAL_SANDBOX_IPN_CALLBACK_URL),
            // Default PayPal IPN url.
            'default_IPN_url' =>
                array(false, null, null, oePayPalIpnConfig::OEPAYPAL_IPN_CALLBACK_URL),
    ...
    public function testGetIpnResponseUrl()
    {
        ...
        $ipnConfig = $this->getMock('oePayPalIpnConfig', array('getIpnUrl'));
