...
class Unit_oePayPal_Models_oePayPalIPNPaymentCreatorTest extends \OxidEsales\TestingLibrary\UnitTestCase
{
    ...
    public function testSetGetRequest()
    {
        ...
        $paymentBuilder = oxNew('oePayPalIPNPaymentCreator');
    ...
    public function testPayPalIPNPaymentCreationNoParentFound()
    {
        ...
        $paymentCreator = oxNew('oepaypalIPNPaymentCreator');
     ...
     *
     * @param string $mode Chose type of orderpayment (authorization or capture)
     * @param bool   $save Set true to store object in db, defaults to fals.
     *
     * @return oePayPalOrderPayment
     */
