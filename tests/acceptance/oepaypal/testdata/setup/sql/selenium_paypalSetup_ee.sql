...
UPDATE `oxshops` SET `OXINFOEMAIL` = 'testing_account@oxid-esales.com', `OXORDEREMAIL` = 'testing_account@oxid-esales.com', `OXOWNEREMAIL` = 'testing_account@oxid-esales.com', `OXSMTP` = '10.255.255.49', `OXDEFCAT` = '' WHERE `OXID` = '1';
