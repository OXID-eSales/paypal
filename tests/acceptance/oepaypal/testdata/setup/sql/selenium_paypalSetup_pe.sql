...
UPDATE `oxshops` SET `OXINFOEMAIL` = 'birute_test@nfq.lt', `OXORDEREMAIL` = 'birute_test@nfq.lt', `OXOWNEREMAIL` = 'birute_test@nfq.lt', `OXSMTP` = 'localhost', `OXDEFCAT` = '', `OXVERSION`='4.6.3' WHERE `OXID` = 'oxbaseshop';
