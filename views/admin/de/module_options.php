...
$aLang = array(
    ...
    'SHOP_MODULE_oePayPalBannersStartPageSelector'           => '[TR]Start page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersStartPageSelector'      => '[TR]Default values for flow and wave themes are: \'#wrapper .row\' and \'#wrapper .container\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersCategoryPage'                => 'Ratenzahlung-Banner auf Kategorieseiten anzeigen',
    'SHOP_MODULE_oePayPalBannersCategoryPageSelector'        => '[TR]Category page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersCategoryPageSelector'   => '[TR]Default values for flow and wave themes are: \'.page-header\' and \'.page-header\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersSearchResultsPage'           => 'Ratenzahlung-Banner bei Suchergebnissen anzeigen',
    'SHOP_MODULE_oePayPalBannersSearchResultsPageSelector'   => '[TR]Search result page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersSearchResultsPageSelector' => '[TR]Default values for flow and wave themes are: \'#content .page-header .clearfix\' and \'.page-header\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersProductDetailsPage'          => 'Ratenzahlung-Banner auf Detailseiten anzeigen',
    'SHOP_MODULE_oePayPalBannersProductDetailsPageSelector'  => '[TR]Product detail page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersProductDetailsPageSelector' => '[TR]Default values for flow and wave themes are: \'.detailsParams\' and \'#detailsItemsPager\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersCheckoutPage'                => 'Ratenzahlung-Banner im Warenkorb anzeigen',
    'SHOP_MODULE_oePayPalBannersCartPageSelector'            => '[TR]Cart page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersCartPageSelector'       => '[TR]Default values for flow and wave themes are: \'.cart-buttons\' and \'.cart-buttons\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersPaymentPageSelector'         => '[TR]Payment page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersPaymentPageSelector'    => '[TR]Default values for flow and wave themes are: \'.checkoutSteps ~ .spacer\' and \'.checkout-steps\'. After these selectors the banner will be shown.',
