...
$aLang = array(
    ...
    'SHOP_MODULE_oePayPalBannersStartPageSelector'           => '[TR]Start page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersStartPageSelector'      => '[TR]Default values for flow and wave themes are: \'#content\' and \'#content\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersCategoryPage'                => 'Ratenzahlung-Banner auf Kategorieseiten anzeigen',
    'SHOP_MODULE_oePayPalBannersCategoryPageSelector'        => '[TR]Category page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersCategoryPageSelector'   => '[TR]Default values for flow and wave themes are: \'.page-header\' and \'.page-header\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersSearchResultsPage'           => 'Ratenzahlung-Banner bei Suchergebnissen anzeigen',
    'SHOP_MODULE_oePayPalBannersSearchResultsPageSelector'   => '[TR]Search result page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersSearchResultsPageSelector' => '[TR]Default values for flow and wave themes are: \'.page-header\' and \'.page-header\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersProductDetailsPage'          => 'Ratenzahlung-Banner auf Detailseiten anzeigen',
    'SHOP_MODULE_oePayPalBannersProductDetailsPageSelector'  => '[TR]Product detail page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersProductDetailsPageSelector' => '[TR]Default values for flow and wave themes are: \'.detailsParams\' and \'#detailsItemsPager\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersCheckoutPage'                => 'Ratenzahlung-Banner im Warenkorb anzeigen',
    'SHOP_MODULE_oePayPalBannersCartPageSelector'            => '[TR]Cart page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersCartPageSelector'       => '[TR]Default values for flow and wave themes are: \'#basket-paypal-installment-banner\' and \'#basket-paypal-installment-banner\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersPaymentPageSelector'         => '[TR]Payment page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersPaymentPageSelector'    => '[TR]Default values for flow and wave themes are: \'#content\' and \'#content\'. The banner will be shown as last element into these selectors.',
