...
$aLang = array(
    ...
    'SHOP_MODULE_oePayPalBannersStartPageSelector'           => 'Start page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersStartPageSelector'      => 'Default values for flow and wave themes are: \'#wrapper .row\' and \'#wrapper .container\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersCategoryPage'                => 'Show installment banner on category pages',
    'SHOP_MODULE_oePayPalBannersCategoryPageSelector'        => 'Category page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersCategoryPageSelector'   => 'Default values for flow and wave themes are: \'.page-header\' and \'.page-header\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersSearchResultsPage'           => 'Show installment banner on search results pages',
    'SHOP_MODULE_oePayPalBannersSearchResultsPageSelector'   => 'Search result page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersSearchResultsPageSelector' => 'Default values for flow and wave themes are: \'#content .page-header .clearfix\' and \'.page-header\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersProductDetailsPage'          => 'Show installment banner on product details pages',
    'SHOP_MODULE_oePayPalBannersProductDetailsPageSelector'  => 'Product detail page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersProductDetailsPageSelector' => 'Default values for flow and wave themes are: \'.detailsParams\' and \'#detailsItemsPager\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersCheckoutPage'                => 'Show installment banner on checkout pages',
    'SHOP_MODULE_oePayPalBannersCartPageSelector'            => 'Cart page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersCartPageSelector'       => 'Default values for flow and wave themes are: \'.cart-buttons\' and \'.cart-buttons\'. After these selectors the banner will be shown.',
    'SHOP_MODULE_oePayPalBannersPaymentPageSelector'         => 'Payment page selector, after which will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersPaymentPageSelector'    => 'Default values for flow and wave themes are: \'.checkoutSteps ~ .spacer\' and \'.checkout-steps\'. After these selectors the banner will be shown.',
