...
$aLang = array(
    ...
    'SHOP_MODULE_oePayPalBannersStartPageSelector'           => 'Start page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersStartPageSelector'      => 'Default values for flow and wave themes are: \'#content\' and \'#content\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersCategoryPage'                => 'Show installment banner on category pages',
    'SHOP_MODULE_oePayPalBannersCategoryPageSelector'        => 'Category page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersCategoryPageSelector'   => 'Default values for flow and wave themes are: \'.page-header\' and \'.page-header\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersSearchResultsPage'           => 'Show installment banner on search results pages',
    'SHOP_MODULE_oePayPalBannersSearchResultsPageSelector'   => 'Search result page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersSearchResultsPageSelector' => 'Default values for flow and wave themes are: \'.page-header\' and \'.page-header\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersProductDetailsPage'          => 'Show installment banner on product details pages',
    'SHOP_MODULE_oePayPalBannersProductDetailsPageSelector'  => 'Product detail page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersProductDetailsPageSelector' => 'Default values for flow and wave themes are: \'.detailsParams\' and \'#detailsItemsPager\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersCheckoutPage'                => 'Show installment banner on checkout pages',
    'SHOP_MODULE_oePayPalBannersCartPageSelector'            => 'Cart page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersCartPageSelector'       => 'Default values for flow and wave themes are: \'#basket-paypal-installment-banner\' and \'#basket-paypal-installment-banner\'. The banner will be shown as last element into these selectors.',
    'SHOP_MODULE_oePayPalBannersPaymentPageSelector'         => 'Payment page selector, in which as last element will be shown the banner',
    'HELP_SHOP_MODULE_oePayPalBannersPaymentPageSelector'    => 'Default values for flow and wave themes are: \'#content\' and \'#content\'. The banner will be shown as last element into these selectors.',
